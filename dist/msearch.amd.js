define('msearch', function () { 'use strict';
...
var m$1 = cssobjMithril_cjs$1(mithril)(cssobj_cjs$1(css, {local:true}));
...
var mSearch = {
  ...
  view: function view(ctrl, options) {
    return m$1('.input', [
      m$1('input'),
      options.hasClear ? m$1('.clear', '×') : [],
      options.hasConfirm ? m$1('.confirm', '✓') : []
    ])
  }
};
